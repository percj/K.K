...
{
    public class MWFXFireProjectile : MonoBehaviour
    {
        [SerializeField]
        ...
        //    MyGUI _GUI;
        MWFXButtonScript selectedProjectileButton;

        void Start()
        {
            selectedProjectileButton = GameObject.Find("Button").GetComponent<MWFXButtonScript>();
        }
